...
f = "Z:/GitHub/jl-spatial/Whittaker2.jl/scripts/Project_Global_LAI_smoothing/OUTPUT/global_param_lambda_cv_2018-2022.zarr"
ds = open_dataset(f)
...
handle = big_heatmap!(ax_xy, lon, lat, lambda)
Colorbar(fig[:, 0], handle, height=Relative(0.5))
